...
--
-- Name: elements nam_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: properties fkey_number; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkey_number FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties fkey_type_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkey_type_id FOREIGN KEY (type_id) REFERENCES public.types(type_id);
